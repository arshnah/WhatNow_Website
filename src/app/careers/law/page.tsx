        ...
        <section>
          ...
          <div className="bg-emerald-50 border-l-4 border-emerald-500 p-6 rounded-r-xl">
            <p className="text-slate-800 leading-relaxed font-medium">
              <strong className="font-black text-emerald-700">{t.warningTitle} </strong>
              {t.warningText}
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4">
            ...
            <div className="group flex flex-col md:flex-row gap-6 bg-white/60 backdrop-blur-sm border border-slate-200/80 rounded-[2rem] p-6 md:p-8 hover:border-slate-300 hover:bg-white/80 transition-all duration-300 shadow-sm">
              ...
              <div className="flex-1">
                ...
                <span className="inline-block bg-emerald-550/10 text-emerald-600 text-xs font-black uppercase tracking-wider px-3.5 py-1.5 rounded-full border border-emerald-100">{t.badgeComingSoon}</span>
              </div>
            </div>
