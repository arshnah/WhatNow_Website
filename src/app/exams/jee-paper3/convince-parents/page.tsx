  ...
  return (
    <main className="flex-grow flex flex-col bg-slate-50 dark:bg-[#0B111C] min-h-screen">
      ...
      <JsonLd
        data={faqJsonLd({
          faqs: [
            { q: "What is B.Planning? Is it a sub-degree or a real career?", a: "B.Planning is a highly professional, AICTE-approved 4-year degree. It is recognized by the Institute of Town Planners, India (ITPI). With India building 100 Smart Cities and investing ₹10+ Lakh Crores in urban infrastructure, the need for specialized planners who understand zoning laws, economic feasibility, and GIS mapping is at an all-time high. Traditional civil engineers do not study these policy frameworks." },
            { q: "Do planners get corporate jobs, or is it only government contracts?", a: "No — planners are hired across the private sector. Real estate consultancies (JLL, Knight Frank, Cushman) hire valuation analysts at ₹5.0L - ₹8.0L/yr; infrastructure developers (L&T, Tata Projects) hire transport network planners and smart city executives at ₹6.0L - ₹9.0L/yr; and policy research bodies & NGOs (WRI India, NIUA, World Bank projects) hire research associates at ₹4.5L - ₹7.0L/yr." },
            { q: "Is B.Planning a good financial investment?", a: "If you secure admission in the School of Planning and Architecture (SPA Delhi, Bhopal, or Vijayawada), tuition fees are heavily subsidized by the Central Government (~₹1.8L - ₹2.5L per year). This makes B.Planning at SPAs one of the most high-ROI degrees in the country compared to private engineering colleges that charge ₹15L - ₹20L with similar or lower starting salary packages." },
          ],
        })}
      />
      <PageHeader
