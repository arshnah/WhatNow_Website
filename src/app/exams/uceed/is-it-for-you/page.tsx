      ...
      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Suitability Check">
          <p className="text-lg text-slate-600 leading-relaxed mb-6 font-medium">
            This section will contain a curated self-assessment blueprint to help you figure out if a Bachelor of Design (B.Des) at an IIT matches your interests, strengths, and long-term career aspirations.
          </p>
          <InfoBox type="info">
