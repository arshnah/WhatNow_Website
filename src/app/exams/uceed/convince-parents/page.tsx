  ...
  return (
    <main className="flex-grow flex flex-col bg-slate-50 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Talking Design With Parents">
          <p className="text-lg text-slate-600 leading-relaxed mb-6 font-medium">
            This section will provide an action plan, data sheets on starting salaries, and career stability metrics to present to parents who only understand traditional paths.
          </p>
          <InfoBox type="info">
