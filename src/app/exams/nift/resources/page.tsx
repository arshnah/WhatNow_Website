...
export const metadata = {
  title: "NIFT Entrance — Resources | WhatNow",
};
      ...
      <PageHeader
        ...
        breadcrumbs={
          <>
            ...
            <span>›</span>
            <span className="text-pink-600">Resources</span>
          </>
        }
      />

      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Preparation & Study Material">
          <p className="text-lg text-slate-600 leading-relaxed mb-6 font-medium">
            This section will contain a curated list of study materials, recommended textbooks, and free video series covering the NIFT Creative Ability Test (CAT) and General Ability Test (GAT) papers.
          </p>
          <InfoBox type="info">
            <h4 className="font-black mb-2">Curation in Progress</h4>
            <p className="text-slate-750 font-medium">
              We are currently curating the best self-study resources, mock tests, and sketching guidelines for NIFT from seniors who successfully cleared the entrance without enrolling in expensive coaching classes. Check back shortly.
            </p>
          </InfoBox>
        </Section>
      </div>
