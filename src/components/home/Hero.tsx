...
import CareerWizard from "./CareerWizard";
...
export default function Hero() {
  ...
  return (
    <main className="flex-1">
      ...
      {/* Career Pathfinder Wizard Modal */}
      <CareerWizard isOpen={isWizardOpen} onClose={() => setIsWizardOpen(false)} />
    </main>
  );
}